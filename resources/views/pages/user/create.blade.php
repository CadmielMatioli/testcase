<x-app-layout>
    ...
    <div class="flex items-center justify-between">
        <h2 class="text-xl font-bold text-gray-800 ">Criar novo usuário</h2>
    ...
    <section>
        <form action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="grid sm:grid-cols-12 md:grid-cols-12 lg:grid-cols-12 gap-6 mt-4 py-5 items-center">
                ...
                <div class="sm:col-span-12 md:col-span-6 lg:col-span-3">
                    <label for="type">
                        ...
                        <select value="{{old('class_room')}}" name="class_room" class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm form-control w-full" id="type" name="quantity">
